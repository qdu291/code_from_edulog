...
--
-- Name: entity_ids; Type: TABLE; Schema: public; Owner: edulog
--

CREATE TABLE public.entity_ids (
    report_info_id bigint NOT NULL,
    entity_id bigint NOT NULL
);


ALTER TABLE public.entity_ids OWNER TO edulog;

--
-- Name: entity_ids_entity_id_seq; Type: SEQUENCE; Schema: public; Owner: edulog
--

CREATE SEQUENCE public.entity_ids_entity_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.entity_ids_entity_id_seq OWNER TO edulog;

--
-- Name: entity_ids_entity_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: edulog
--

ALTER SEQUENCE public.entity_ids_entity_id_seq OWNED BY public.entity_ids.entity_id;


--
-- Name: entity_ids_report_info_id_seq; Type: SEQUENCE; Schema: public; Owner: edulog
--

CREATE SEQUENCE public.entity_ids_report_info_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.entity_ids_report_info_id_seq OWNER TO edulog;

--
-- Name: entity_ids_report_info_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: edulog
--

ALTER SEQUENCE public.entity_ids_report_info_id_seq OWNED BY public.entity_ids.report_info_id;
...
--
-- Name: depot; Type: TABLE; Schema: rp_plan; Owner: edulog
--

CREATE TABLE rp_plan.depot (
    id bigint NOT NULL,
    surrogate_key uuid DEFAULT public.uuid_generate_v4() NOT NULL,
...
ALTER TABLE rp_plan.depot OWNER TO edulog;

--
-- Name: depot_id_seq; Type: SEQUENCE; Schema: rp_plan; Owner: edulog
--

CREATE SEQUENCE rp_plan.depot_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE rp_plan.depot_id_seq OWNER TO edulog;

--
-- Name: depot_id_seq; Type: SEQUENCE OWNED BY; Schema: rp_plan; Owner: edulog
--

ALTER SEQUENCE rp_plan.depot_id_seq OWNED BY rp_plan.depot.id;
...
--
-- Name: entity_ids report_info_id; Type: DEFAULT; Schema: public; Owner: edulog
--

ALTER TABLE ONLY public.entity_ids ALTER COLUMN report_info_id SET DEFAULT nextval('public.entity_ids_report_info_id_seq'::regclass);


--
-- Name: entity_ids entity_id; Type: DEFAULT; Schema: public; Owner: edulog
--

ALTER TABLE ONLY public.entity_ids ALTER COLUMN entity_id SET DEFAULT nextval('public.entity_ids_entity_id_seq'::regclass);
...
--
-- Name: depot id; Type: DEFAULT; Schema: rp_plan; Owner: edulog
--

ALTER TABLE ONLY rp_plan.depot ALTER COLUMN id SET DEFAULT nextval('rp_plan.depot_id_seq'::regclass);
...
--
-- Data for Name: entity_ids; Type: TABLE DATA; Schema: public; Owner: edulog
--

COPY public.entity_ids (report_info_id, entity_id) FROM stdin;
\.
...
1	1.000	 Initial Schema	SQL	V1.000__Initial_Schema.sql	-1835402115	edulog	2020-06-01 16:35:59.102709	1280	t
2	1.001	 District Eligibility	SQL	V1.001__District_Eligibility.sql	1437386594	edulog	2020-06-01 16:36:00.40621	13	t
3	1.002	 Update Contacts	SQL	V1.002__Update_Contacts.sql	715809704	edulog	2020-06-01 16:36:00.424454	4	t
4	1.003	 TR Denied to Rejected Status	SQL	V1.003__TR_Denied_to_Rejected_Status.sql	-1957266663	edulog	2020-06-01 16:36:00.432642	1	t
5	1.004	 Add Vehicle Table	SQL	V1.004__Add_Vehicle_Table.sql	-294536344	edulog	2020-06-01 16:36:00.437289	13	t
6	2.000	 Update Multi Cover Support	SQL	V2.000__Update_Multi_Cover_Support.sql	1673229542	edulog	2020-06-01 16:36:00.454299	38	t
7	2.001	 Add Bell Times On Walk Paths	SQL	V2.001__Add_Bell_Times_On_Walk_Paths.sql	-23331641	edulog	2020-06-01 16:36:00.497585	2	t
8	2.002	 Add Stop Active	SQL	V2.002__Add_Stop_Active.sql	-1436412535	edulog	2020-06-01 16:36:00.504519	4	t
9	2.003	 inactivated student data	SQL	V2.003__inactivated_student_data.sql	1415246562	edulog	2020-06-01 16:36:00.512139	8	t
10	2.004	 Remove Trips for NonFinal TRs	SQL	V2.004__Remove_Trips_for_NonFinal_TRs.sql	-778404108	edulog	2020-06-01 16:36:00.524511	3	t
11	2.005	 User Management Tables	SQL	V2.005__User_Management_Tables.sql	-1345321540	edulog	2020-06-01 16:36:00.531232	15	t
12	2.006	 Calendar and Rollover Tables	SQL	V2.006__Calendar_and_Rollover_Tables.sql	850886303	edulog	2020-06-01 16:36:00.551011	10	t
13	2.007	 Increase Waypoint Description Length	SQL	V2.007__Increase_Waypoint_Description_Length.sql	-1441796114	edulog	2020-06-01 16:36:00.565434	1	t
14	2.008	 Calendar and Rollover Table Mods	SQL	V2.008__Calendar_and_Rollover_Table_Mods.sql	1248161702	edulog	2020-06-01 16:36:00.569954	1	t
15	2.009	 Add Gps DeviceId	SQL	V2.009__Add_Gps_DeviceId.sql	-369982840	edulog	2020-06-01 16:36:00.574394	1	t
16	2.010	 Add Max Assign Dist	SQL	V2.010__Add_Max_Assign_Dist.sql	1986082233	edulog	2020-06-01 16:36:00.578744	1	t
17	2.011	 Access Management	SQL	V2.011__Access_Management.sql	-2049021688	edulog	2020-06-01 16:36:00.583306	12	t
18	2.012	 Add Plan Rollover Log Table	SQL	V2.012__Add_Plan_Rollover_Log_Table.sql	1240503011	edulog	2020-06-01 16:36:00.599633	4	t
19	2.013	 Role Permissions Table	SQL	V2.013__Role_Permissions_Table.sql	-1726542837	edulog	2020-06-01 16:36:00.60665	13	t
20	2.014	 school district update	SQL	V2.014__school_district_update.sql	1507848293	edulog	2020-06-01 16:36:00.624746	4	t
21	2.015	 Fix Vin Type	SQL	V2.015__Fix_Vin_Type.sql	-150389474	edulog	2020-06-01 16:36:00.632831	2	t
22	2.016	 Initial Report Functions	SQL	V2.016__Initial_Report_Functions.sql	1176482092	edulog	2020-06-01 16:36:00.638735	10	t
23	2.017	 GeoCode	SQL	V2.017__GeoCode.sql	927029896	edulog	2020-06-01 16:36:00.6542	38	t
24	2.018	 Update TR Structure For Eff Dates	SQL	V2.018__Update_TR_Structure_For_Eff_Dates.sql	1379037620	edulog	2020-06-01 16:36:00.698006	25	t
25	2.019	 GeoCode Boundary	SQL	V2.019__GeoCode_Boundary.sql	-144711022	edulog	2020-06-01 16:36:00.728415	7	t
26	2.020	 Add StudentImportTables	SQL	V2.020__Add_StudentImportTables.sql	-398732669	edulog	2020-06-01 16:36:00.739982	17	t
27	2.021	 Fix BoundaryCode Type	SQL	V2.021__Fix_BoundaryCode_Type.sql	-1521420475	edulog	2020-06-01 16:36:00.760685	3	t
28	2.022	 Add Calendar Table	SQL	V2.022__Add_Calendar_Table.sql	1841516164	edulog	2020-06-01 16:36:00.76756	9	t
29	2.023	 Updating student imp related tables	SQL	V2.023__Updating_student_imp_related_tables.sql	-1910154654	edulog	2020-06-01 16:36:00.779991	2	t
30	2.024	 Add Edta Schema Tables backup	SQL	V2.024__Add_Edta_Schema_Tables_backup.sql	1913517184	edulog	2020-06-01 16:36:00.785364	80	t
31	2.025	 Add Ivin Schema Tables backup	SQL	V2.025__Add_Ivin_Schema_Tables_backup.sql	-1514393161	edulog	2020-06-01 16:36:00.871701	24	t
32	2.026	 Fix Calendar Table	SQL	V2.026__Fix_Calendar_Table.sql	-1734003985	edulog	2020-06-01 16:36:00.900483	5	t
33	2.027	 Updating StudImp Tables	SQL	V2.027__Updating_StudImp_Tables.sql	-1669818610	edulog	2020-06-01 16:36:00.909578	1	t
34	2.028	 Update Boundary Seq	SQL	V2.028__Update_Boundary_Seq.sql	-165076124	edulog	2020-06-01 16:36:00.914029	1	t
35	2.029	 Add Vehicle Service Table	SQL	V2.029__Add_Vehicle_Service_Table.sql	1874881145	edulog	2020-06-01 16:36:00.918747	2	t
36	2.030	 Vehicle Route Contractor Updates	SQL	V2.030__Vehicle_Route_Contractor_Updates.sql	-2034161314	edulog	2020-06-01 16:36:00.924813	18	t
37	2.031	 Fix Extra End Of Path Dir Steps	SQL	V2.031__Fix_Extra_End_Of_Path_Dir_Steps.sql	-1476256081	edulog	2020-06-01 16:36:00.946441	1	t
38	2.032	 Fixed Aggregation Supervisor Driver Time Attendance	SQL	V2.032__Fixed_Aggregation_Supervisor_Driver_Time_Attendance.sql	1399287747	edulog	2020-06-01 16:36:00.949793	3	t
39	2.033	 Fix StudentImp config	SQL	V2.033__Fix_StudentImp_config.sql	1805609036	edulog	2020-06-01 16:36:00.955896	4	t
40	2.034	 StudentImp mapping	SQL	V2.034__StudentImp_mapping.sql	1213966813	edulog	2020-06-01 16:36:00.964155	1	t
41	2.035	 StudImp mapping	SQL	V2.035__StudImp_mapping.sql	1227478161	edulog	2020-06-01 16:36:00.968367	5	t
42	2.036	 StudImp adjustColumn	SQL	V2.036__StudImp_adjustColumn.sql	-483518222	edulog	2020-06-01 16:36:00.977239	1	t
43	2.037	 Update Plan Rollover And Removal Calendar	SQL	V2.037__Update_Plan_Rollover_And_Removal_Calendar.sql	-1309002373	edulog	2020-06-01 16:36:00.980404	10	t
44	2.038	 Report Tables	SQL	V2.038__Report_Tables.sql	-1697893018	edulog	2020-06-01 16:36:00.996801	5	t
45	2.039	 Routing Data Area Schema Separation	SQL	V2.039__Routing_Data_Area_Schema_Separation.sql	-2025071700	edulog	2020-06-01 16:36:01.006185	47	t
46	2.040	 Data Area Functions	SQL	V2.040__Data_Area_Functions.sql	-1002796147	edulog	2020-06-01 16:36:01.058897	7	t
47	2.041	 GEO Add posts to boundary add boundary group	SQL	V2.041__GEO_Add_posts_to_boundary_add_boundary_group.sql	1037532868	edulog	2020-06-01 16:36:01.069937	4	t
48	2.042	 Report Tables	SQL	V2.042__Report_Tables.sql	942219105	edulog	2020-06-01 16:36:01.077335	2	t
49	2.043	 DA Create Boundary Group Post	SQL	V2.043__DA_Create_Boundary_Group_Post.sql	-1196213688	edulog	2020-06-01 16:36:01.083072	9	t
50	2.044	 DA Add Eligibility Rule	SQL	V2.044__DA_Add_Eligibility_Rule.sql	1018040554	edulog	2020-06-01 16:36:01.097456	9	t
51	2.045	 Fix Routing User Audit Columns	SQL	V2.045__Fix_Routing_User_Audit_Columns.sql	-211648470	edulog	2020-06-01 16:36:01.109796	6	t
52	2.046	 DA Fix Boundary Group Sequence	SQL	V2.046__DA_Fix_Boundary_Group_Sequence.sql	816274931	edulog	2020-06-01 16:36:01.11875	1	t
53	2.047	 Fix User And Cal Table Sequences	SQL	V2.047__Fix_User_And_Cal_Table_Sequences.sql	2001429657	edulog	2020-06-01 16:36:01.12278	4	t
54	2.048	 DA Posting With No Boundary	SQL	V2.048__DA_Posting_With_No_Boundary.sql	2126753566	edulog	2020-06-01 16:36:01.129505	1	t
55	2.049	 DA Plan Add Indexes To FKs	SQL	V2.049__DA_Plan_Add_Indexes_To_FKs.sql	1718012063	edulog	2020-06-01 16:36:01.133123	45	t
56	2.050	 CreateExtension	SQL	V2.050__CreateExtension.sql	-1148974962	edulog	2020-06-01 16:36:01.18204	10	t
57	2.051	 DA Add Dynamic Frequency Property	SQL	V2.051__DA_Add_Dynamic_Frequency_Property.sql	421415597	edulog	2020-06-01 16:36:01.194414	1	t
58	2.052	 DA FixDynamicFreqValues	SQL	V2.052__DA_FixDynamicFreqValues.sql	-150819789	edulog	2020-06-01 16:36:01.197881	6	t
59	2.053	 DA Add Column Extend Point Info	SQL	V2.053__DA_Add_Column_Extend_Point_Info.sql	651183544	edulog	2020-06-01 16:36:01.207028	1	t
60	2.054	 Add Column Report Title	SQL	V2.054__Add_Column_Report_Title.sql	-1433223858	edulog	2020-06-01 16:36:01.21036	1	t
61	2.055	 DA Append Boundary Group	SQL	V2.055__DA_Append_Boundary_Group.sql	1812251679	edulog	2020-06-01 16:36:01.214095	6	t
62	2.056	 Remove Column Mapping Fields	SQL	V2.056__Remove_Column_Mapping_Fields.sql	1184069717	edulog	2020-06-01 16:36:01.222577	1	t
63	2.057	 Reports Modify column user name	SQL	V2.057__Reports_Modify_column_user_name.sql	-2095736535	edulog	2020-06-01 16:36:01.226505	0	t
64	2.058	 DA Location Add Changed Deleted	SQL	V2.058__DA_Location_Add_Changed_Deleted.sql	-690857263	edulog	2020-07-08 14:34:50.259268	21	t
65	2.058.01	 DA Segment Add Updated Created Column	SQL	V2.058.01__DA_Segment_Add_Updated_Created_Column.sql	-1076056504	edulog	2020-07-08 14:34:50.290255	3	t
66	2.059	 DA Update TripMaster Status	SQL	V2.059__DA_Update_TripMaster_Status.sql	399751219	edulog	2020-07-08 14:34:50.298841	93	t
67	2.060	 DA Drop boundaries RP	SQL	V2.060__DA_Drop_boundaries_RP.sql	1270617611	edulog	2020-07-08 14:34:50.398296	43	t
68	2.061	 Add ExportFile Table	SQL	V2.061__Add_ExportFile_Table.sql	976696798	edulog	2020-07-08 14:34:50.451226	31	t
\.
...
COPY rp_master.cal (id, name_of, description, calendar_type, user_id, time_changed, surrogate_key) FROM stdin;
\.
...
1	1bbe1ff4-cb31-4c7f-a990-bfcff8ab5f85	plan	rp_plan	geo_plan	Default planning area	1	SYSTEM	2020-06-01 16:36:01.006185+07
\.
...
--
-- Data for Name: depot; Type: TABLE DATA; Schema: rp_plan; Owner: edulog
--

COPY rp_plan.depot (id, surrogate_key, location_id, code, description, comments, right_side, user_id, time_changed) FROM stdin;
\.
...
1	b5064296-113f-426e-a532-661169ac3c57	ELIGIBLE.	t	migration-V1.001	2020-06-01 16:36:00.40621+07
2	fbf41baa-6131-4d16-8a38-ec276a6404f5	ELIGIBLE DUE TO INJURY.	t	migration-V1.001	2020-06-01 16:36:00.40621+07
3	7e27cf69-7cca-4a67-9471-a347893ce557	ELIGIBLE DUE SPECIAL CIRCUMSTANCE.	t	migration-V1.001	2020-06-01 16:36:00.40621+07
4	0f5c992f-8799-40a1-ba9d-285a45314f84	NOT ELIGIBLE.	f	migration-V1.001	2020-06-01 16:36:00.40621+07
5	5b797d10-6248-4fb7-a303-d4766439440f	NOT ELIGIBLE BEHAVIORAL ISSUES ON THE BUS.	f	migration-V1.001	2020-06-01 16:36:00.40621+07
\.
...
COPY rp_plan.location (id, surrogate_key, address, point, user_id, time_changed) FROM stdin;
\.
...
COPY rp_plan.route (id, surrogate_key, path_master_id, code, description, comments, depot_id, proxy, map_set, user_id, time_changed, create_date, vehicle_id, contractor_id) FROM stdin;
\.
...
COPY rp_plan.run (id, surrogate_key, code, description, to_from, max_duration, max_load, comments, user_id, time_changed, create_date, dynamic_freq) FROM stdin;
\.
...
COPY rp_plan.student (id, surrogate_key, edulog_id, government_id, district_id, first_name, middle_name, last_name, suffix, nick_name, school_operation_master_id, gender, ethnicity, distance_to_school, elg_code, sis_address, sis_apt_number, iep, section_504, home_pickup, home_right_side, home_available, load_time, date_of_birth, max_ride_time, picture_file_name, location_id, mailing_address, rfid, begin_date, enroll_date, withdraw_date, homeroom_teacher, phone, email, user_id, time_changed, create_date, district_eligibility_id) FROM stdin;
\.
...
COPY rp_plan.transport_request (id, surrogate_key, begin_date, end_date, transport_mode, location_id_requested_stop, requested_stop_required, request_source, user_id, time_changed, direction, student_id, transport_def_master_id_to_school, transport_def_master_id_from_school) FROM stdin;
\.
...
COPY rp_plan.trip_master (id, surrogate_key, user_id, time_changed, transport_def_master_id, assigned_status) FROM stdin;
\.
...
COPY rp_plan.vehicle (id, surrogate_key, vin, name_of, capacity, description, gps_unit_id, depot_id, make, model, year_of, comments, user_id, time_changed, create_date, contractor_id, start_of_service, end_of_service, license_number) FROM stdin;
\.
...
--
-- Name: entity_ids_entity_id_seq; Type: SEQUENCE SET; Schema: public; Owner: edulog
--

SELECT pg_catalog.setval('public.entity_ids_entity_id_seq', 1, false);


--
-- Name: entity_ids_report_info_id_seq; Type: SEQUENCE SET; Schema: public; Owner: edulog
--

SELECT pg_catalog.setval('public.entity_ids_report_info_id_seq', 1, false);
...
--
-- Name: depot_id_seq; Type: SEQUENCE SET; Schema: rp_plan; Owner: edulog
--

SELECT pg_catalog.setval('rp_plan.depot_id_seq', 1, false);
...
--
-- Name: depot pk_depot; Type: CONSTRAINT; Schema: rp_plan; Owner: edulog
--

ALTER TABLE ONLY rp_plan.depot
    ADD CONSTRAINT pk_depot PRIMARY KEY (id);
...
--
-- Name: depot uq_depot_location_id; Type: CONSTRAINT; Schema: rp_plan; Owner: edulog
--

ALTER TABLE ONLY rp_plan.depot
    ADD CONSTRAINT uq_depot_location_id UNIQUE (location_id);


--
-- Name: depot uq_depot_surrogate_key; Type: CONSTRAINT; Schema: rp_plan; Owner: edulog
--

ALTER TABLE ONLY rp_plan.depot
    ADD CONSTRAINT uq_depot_surrogate_key UNIQUE (surrogate_key);
...
--
-- Name: idx_route_depot_id_idx; Type: INDEX; Schema: rp_plan; Owner: edulog
--

CREATE INDEX idx_route_depot_id_idx ON rp_plan.route USING btree (depot_id);
...
--
-- Name: idx_vehicle_depot_id_idx; Type: INDEX; Schema: rp_plan; Owner: edulog
--

CREATE INDEX idx_vehicle_depot_id_idx ON rp_plan.vehicle USING btree (depot_id);
...
--
-- Name: entity_ids fk_report_info; Type: FK CONSTRAINT; Schema: public; Owner: edulog
--

ALTER TABLE ONLY public.entity_ids
    ADD CONSTRAINT fk_report_info FOREIGN KEY (report_info_id) REFERENCES public.report_info(id);
...
--
-- Name: depot fk_depot_location_id; Type: FK CONSTRAINT; Schema: rp_plan; Owner: edulog
--

ALTER TABLE ONLY rp_plan.depot
    ADD CONSTRAINT fk_depot_location_id FOREIGN KEY (location_id) REFERENCES rp_plan.location(id);
...
--
-- Name: route fk_route_depot_id; Type: FK CONSTRAINT; Schema: rp_plan; Owner: edulog
--

ALTER TABLE ONLY rp_plan.route
    ADD CONSTRAINT fk_route_depot_id FOREIGN KEY (depot_id) REFERENCES rp_plan.depot(id);
...
--
-- Name: vehicle fk_vehicle_depot_id; Type: FK CONSTRAINT; Schema: rp_plan; Owner: edulog
--

ALTER TABLE ONLY rp_plan.vehicle
    ADD CONSTRAINT fk_vehicle_depot_id FOREIGN KEY (depot_id) REFERENCES rp_plan.depot(id);
