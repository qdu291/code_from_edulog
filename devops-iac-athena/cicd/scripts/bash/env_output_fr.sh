...
# Get RDS Endpoints
export RDSENDPOINT=`python3 ../python/get_output_from_stack_fr.py athena-$TENANT RDSEndpoint`
#echo "RDS Endpoints: ${RDSENDPOINT}"

# Get FrontEnd URL
export FRONTENDURL=`python3 ../python/get_output_from_stack_fr.py athena-$TENANT FrontendURL`
echo "FrontEnd URL: ${FRONTENDURL}"
#echo "FrontEnd URL: ${FRONTENDURL}" >> $TENANT.txt

# Get BackEnd URL
export BACKENDURL=`python3 ../python/get_output_from_stack_fr.py athena-$TENANT BackendURL`
