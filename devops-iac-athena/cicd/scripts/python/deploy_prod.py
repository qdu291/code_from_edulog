    ...
    try:
        ...
        if images:
            ...
            if image:
                ...
                res = os.system(f'/usr/local/bin/update_stack_release {tenant} {image_id} prod')
                if res != 0:
                    print('deploy-prod.update_stack_release.error-code', res)
                    exit(1)
            else:
