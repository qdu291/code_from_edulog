 ...
 *
 * <p/>
 * This parser can only handle one layer. To parse nested constructs, get a new parser for each
...
class DerParser {
    ...
    /**
     * Read next object. If it's constructed, the value holds encoded content and it should be parsed by
     * a new parser from <code>Asn1Object.getParser</code>.
     *
     * @return A object
     * @throws IOException IOException resulted from invalid file IO
     */
     ...
     * <li>Long form. Two to 127 octets (only 4 is supported here). Bit 8 of first octet has value "1"
     * and bits 7-1 give the number of additional length octets. Second and following octets give the
     * length, base 256, most significant digit first.
     * </ul>
     *
...
class Asn1Object {
     ...
     * <li>Type: This is actually called tag in ASN.1. It indicates data type (Integer, String) or a
     * construct (sequence, choice, set).
     * </ul>
     *
