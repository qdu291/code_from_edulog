...
def updateIndex(feVer: str, beVer: str, sitename: str, env_type: str):
  update_body = {
     "script": {
        "inline": "ctx._source.feVersion=params.fever;ctx._source.beVersion=params.bever",
        "params": {
          "fever": feVer,
          "bever": beVer
        },
...
def handler(site_name: str, feVersion: str, beVersion: str, envType: str):
  updateIndex(feVersion, beVersion, site_name, envType)
